...
- Procedural spawning of items (clarity, and potentially other things)
- Procedural props 
...
- Annabelle Lee (painting and animating)
- Prospero (painting animating)
- Lady Rowena
- Mesmirist
- Designs of 3-4 mobs
- UI (![link](https://docs.google.com/forms/d/e/1FAIpQLScWohFscLh07ezRgJVKHNOaGZFMHVlKv2pZWBOAN7qFefIwkg/viewform?usp=sharing&ouid=103527688644023510348))
  - Menu
  - Buttons
  - Combat
  - Pause
  ...
  - Death
  - etc
- Props designs and implementations
- Character portraits
- Weapon(s)
- Attack VFX (ONE VFX)
